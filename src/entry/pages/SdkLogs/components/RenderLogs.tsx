          ...
          <tbody>
            {data.map((item, index) => (
              <tr key={`table-row-${index}-${item._id}`}>
                ...
                <td>
                  <strong className="route">{item.route}</strong>
                </td>
                <td>{item.app.isActive ? item.app.name : "-- n/a --"}</td>
                <td>
                ...
                <td>
                  <span className="green">{item.responseTime}ms</span>
                </td>
                <td>
                  <div className="log">
                    {item.log ? (
                ...
                <td>{formatDistanceToNow(parseISO(item.date))}</td>
              </tr>
            ))}
          </tbody>
        </table>
